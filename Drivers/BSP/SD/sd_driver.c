...
SD_HandleTypeDef uSdHandle; // uSD card handle
...
/**
 * @brief Global vector table SDIO IRQ handler
 */
...
/**
 * @brief Global vector table DMA TX IRQ handler
 *
 */
...
/**
 * @brief Global vector table DMA RX IRQ handler
 *
 */
